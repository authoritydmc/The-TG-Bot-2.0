...
if 1 == 1:
    strings = {
        ...
        "no_reply": "Reply to a message to quote it.",
        "no_template": "Secify a valid template.",
        "delimiter": "</code>, <code>",
        "server_error": "Server error. Please report to developer.",
        "invalid_token": "The api_token env variabled is not set or invalid.",
        ...
        "cannot_send_stickers": "Unable to send stickers in this chat.",
        "admin": "admin",
        "creator": "creator",
        "hidden": "hidden",
        "channel": "Channel"
